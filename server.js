...
let server;
initDb().then(()=>{server=app.listen(PORT,'0.0.0.0',()=>console.log(`🖨️ Gestão 3D v3.2.3 rodando na porta ${PORT}`));}).catch(e=>{console.error('Erro ao inicializar PostgreSQL:',e);process.exit(1)});
