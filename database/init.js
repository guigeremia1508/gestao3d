...
async function ensureColumns(client) {
  const columns = {
    users: { customer_id: 'BIGINT', deleted_at: 'TIMESTAMPTZ' },
    settings: { key: 'TEXT', value: 'TEXT', updated_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    sessions: { revoked_at: 'TIMESTAMPTZ' },
    customers: { deleted_at: 'TIMESTAMPTZ' },
    printers: { purchase_price: 'NUMERIC(14,2) DEFAULT 0', power_watts: 'NUMERIC(10,2) DEFAULT 0', status: "TEXT NOT NULL DEFAULT 'DISPONIVEL'", total_hours: 'NUMERIC(14,2) DEFAULT 0', total_prints: 'INTEGER DEFAULT 0', total_failures: 'INTEGER DEFAULT 0', filament_used_g: 'NUMERIC(14,2) DEFAULT 0', notes: 'TEXT', photo_url: 'TEXT', cloudinary_public_id: 'TEXT', deleted_at: 'TIMESTAMPTZ' },
    maintenance_plans: { printer_id: 'BIGINT', task: 'TEXT', interval_hours: 'NUMERIC(14,2)', interval_days: 'INTEGER', active: 'BOOLEAN NOT NULL DEFAULT TRUE', last_completed_at: 'DATE', last_completed_hours: 'NUMERIC(14,2) DEFAULT 0', next_due_date: 'DATE', next_due_hours: 'NUMERIC(14,2)', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    printer_maintenance: { printer_id: 'BIGINT', plan_id: 'BIGINT', task: 'TEXT', scheduled_at: 'DATE', done_at: 'DATE', hours_at: 'NUMERIC(14,2)', cost: 'NUMERIC(14,2) DEFAULT 0', parts_used: 'TEXT', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    materials: { type: 'TEXT', brand: 'TEXT', color: 'TEXT', color_code: 'TEXT', diameter: 'NUMERIC(5,2) DEFAULT 1.75', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    material_rolls: { material_id: 'BIGINT', code: 'TEXT', initial_weight_g: 'NUMERIC(14,2) DEFAULT 0', current_weight_g: 'NUMERIC(14,2) DEFAULT 0', purchase_price: 'NUMERIC(14,2) DEFAULT 0', cost_per_gram: 'NUMERIC(14,6) DEFAULT 0', supplier: 'TEXT', purchase_date: 'DATE', status: "TEXT DEFAULT 'DISPONIVEL'", min_stock_g: 'NUMERIC(14,2) DEFAULT 50', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    stock_movements: { roll_id: 'BIGINT', type: 'TEXT', reason: 'TEXT', quantity_g: 'NUMERIC(14,2)', reference_id: 'BIGINT', reference_type: 'TEXT', notes: 'TEXT', created_by: 'BIGINT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    tool_consumables: { name: 'TEXT', category: 'TEXT', unit: "TEXT NOT NULL DEFAULT 'un'", current_qty: 'NUMERIC(14,3) NOT NULL DEFAULT 0', min_qty: 'NUMERIC(14,3) NOT NULL DEFAULT 0', unit_cost: 'NUMERIC(14,4) NOT NULL DEFAULT 0', supplier: 'TEXT', notes: 'TEXT', photo_url: 'TEXT', cloudinary_public_id: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    small_parts: { category: 'TEXT', name: 'TEXT', type: 'TEXT', size: 'TEXT', material: 'TEXT', current_qty: 'NUMERIC(14,3) NOT NULL DEFAULT 0', min_qty: 'NUMERIC(14,3) NOT NULL DEFAULT 0', unit_cost: 'NUMERIC(14,4) NOT NULL DEFAULT 0', supplier: 'TEXT', notes: 'TEXT', photo_url: 'TEXT', cloudinary_public_id: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    consumable_movements: { consumable_id: 'BIGINT', type: 'TEXT', quantity: 'NUMERIC(14,3)', reason: 'TEXT', reference_id: 'BIGINT', reference_type: 'TEXT', notes: 'TEXT', created_by: 'BIGINT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    part_movements: { part_id: 'BIGINT', type: 'TEXT', quantity: 'NUMERIC(14,3)', reason: 'TEXT', reference_id: 'BIGINT', reference_type: 'TEXT', notes: 'TEXT', created_by: 'BIGINT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    projects: { name: 'TEXT', description: 'TEXT', type: "TEXT NOT NULL DEFAULT 'COMERCIAL'", status: "TEXT NOT NULL DEFAULT 'EM_DESENVOLVIMENTO'", responsible: 'TEXT', customer_id: 'BIGINT', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    project_versions: { project_id: 'BIGINT', version: 'TEXT', filename: 'TEXT', changes: 'TEXT', reason: 'TEXT', result: 'TEXT', author: 'TEXT', file_storage_key: 'TEXT', file_size: 'BIGINT', file_mime: 'TEXT', file_hash: 'TEXT', file_storage_provider: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    project_parts: { project_id: 'BIGINT', deleted_at: 'TIMESTAMPTZ', part_id: 'BIGINT', quantity: 'NUMERIC(14,3)', unit_cost: 'NUMERIC(14,4) DEFAULT 0', total_cost: 'NUMERIC(14,4) DEFAULT 0', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    audit_logs: { user_id: 'BIGINT', action: 'TEXT', entity: 'TEXT', entity_id: 'BIGINT', ip: 'INET', result: "TEXT NOT NULL DEFAULT 'SUCCESS'", created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    tests: { project_id: 'BIGINT', version_id: 'BIGINT', printer_id: 'BIGINT', roll_id: 'BIGINT', est_time_min: 'NUMERIC(14,2) DEFAULT 0', real_time_min: 'NUMERIC(14,2) DEFAULT 0', est_weight_g: 'NUMERIC(14,2) DEFAULT 0', real_weight_g: 'NUMERIC(14,2) DEFAULT 0', waste_g: 'NUMERIC(14,2) DEFAULT 0', temp_nozzle: 'NUMERIC(8,2)', temp_bed: 'NUMERIC(8,2)', layer_height: 'NUMERIC(8,3)', infill: 'INTEGER', walls: 'INTEGER', speed: 'NUMERIC(8,2)', supports: 'BOOLEAN DEFAULT FALSE', result: 'TEXT', failure_type: 'TEXT', failure_cause: 'TEXT', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    products: { code: 'TEXT', name: 'TEXT', project_id: 'BIGINT', version_id: 'BIGINT', material_type: 'TEXT', weight_g: 'NUMERIC(14,2) DEFAULT 0', print_time_min: 'NUMERIC(14,2) DEFAULT 0', cost_material: 'NUMERIC(14,2) DEFAULT 0', cost_energy: 'NUMERIC(14,2) DEFAULT 0', cost_machine: 'NUMERIC(14,2) DEFAULT 0', cost_labor: 'NUMERIC(14,2) DEFAULT 0', cost_packaging: 'NUMERIC(14,2) DEFAULT 0', cost_finishing: 'NUMERIC(14,2) DEFAULT 0', cost_parts: 'NUMERIC(14,2) DEFAULT 0', cost_project_parts: 'NUMERIC(14,2) DEFAULT 0', cost_maintenance: 'NUMERIC(14,2) DEFAULT 0', cost_total: 'NUMERIC(14,2) DEFAULT 0', price: 'NUMERIC(14,2) DEFAULT 0', markup: 'NUMERIC(14,2) DEFAULT 0', margin: 'NUMERIC(14,2) DEFAULT 0', printer_id: 'BIGINT', material_roll_id: 'BIGINT', development_time_min: 'NUMERIC(14,2) DEFAULT 0', costs_manual: 'BOOLEAN NOT NULL DEFAULT FALSE', active: 'BOOLEAN DEFAULT TRUE', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    product_components: { product_id: 'BIGINT', part_id: 'BIGINT', consumable_id: 'BIGINT', quantity: 'NUMERIC(14,3)', unit_cost: 'NUMERIC(14,4) DEFAULT 0', total_cost: 'NUMERIC(14,4) DEFAULT 0', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    orders: { customer_id: 'BIGINT', product_id: 'BIGINT', quantity: 'INTEGER DEFAULT 1', material: 'TEXT', roll_id: 'BIGINT', unit_price: 'NUMERIC(14,2) DEFAULT 0', discount: 'NUMERIC(14,2) DEFAULT 0', total: 'NUMERIC(14,2) DEFAULT 0', payment_method: 'TEXT', due_date: 'DATE', notes: 'TEXT', status: "TEXT NOT NULL DEFAULT 'ORCAMENTO'", created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    production_jobs: { order_id: 'BIGINT', project_id: 'BIGINT', version_id: 'BIGINT', product_id: 'BIGINT', printer_id: 'BIGINT', roll_id: 'BIGINT', est_weight_g: 'NUMERIC(14,2) DEFAULT 0', real_weight_g: 'NUMERIC(14,2) DEFAULT 0', est_time_min: 'NUMERIC(14,2) DEFAULT 0', real_time_min: 'NUMERIC(14,2) DEFAULT 0', waste_g: 'NUMERIC(14,2) DEFAULT 0', started_at: 'TIMESTAMPTZ', finished_at: 'TIMESTAMPTZ', result: 'TEXT', failure_type: 'TEXT', failure_cause: 'TEXT', status: "TEXT NOT NULL DEFAULT 'AGUARDANDO'", notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    production_component_usages: { production_id: 'BIGINT', product_component_id: 'BIGINT', component_kind: 'TEXT', component_id: 'BIGINT', quantity: 'NUMERIC(14,3)', unit_cost: 'NUMERIC(14,4) DEFAULT 0', total_cost: 'NUMERIC(14,4) DEFAULT 0', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()' },
    transactions: { type: 'TEXT', category: 'TEXT', description: 'TEXT', amount: 'NUMERIC(14,2)', date: 'DATE', reference_id: 'BIGINT', reference_type: 'TEXT', paid: 'BOOLEAN DEFAULT FALSE', due_date: 'DATE', paid_at: 'TIMESTAMPTZ', notes: 'TEXT', created_at: 'TIMESTAMPTZ NOT NULL DEFAULT NOW()', deleted_at: 'TIMESTAMPTZ' },
    quotes: { customer_id: 'BIGINT', project_id: 'BIGINT', product_id: 'BIGINT', printer_id: 'BIGINT', roll_id: 'BIGINT', product_description: 'TEXT', quantity: 'INTEGER NOT NULL DEFAULT 1', project_time_min: 'NUMERIC(14,2) NOT NULL DEFAULT 0', weight_g: 'NUMERIC(14,2) NOT NULL DEFAULT 0', print_time_min: 'NUMERIC(14,2) NOT NULL DEFAULT 0', labor_cost: 'NUMERIC(14,2) NOT NULL DEFAULT 0', other_costs: 'NUMERIC(14,2) NOT NULL DEFAULT 0', cost_material: 'NUMERIC(14,2) NOT NULL DEFAULT 0', cost_energy: 'NUMERIC(14,2) NOT NULL DEFAULT 0', cost_machine: 'NUMERIC(14,2) NOT NULL DEFAULT 0', cost_maintenance: 'NUMERIC(14,2) NOT NULL DEFAULT 0', cost_total: 'NUMERIC(14,2) NOT NULL DEFAULT 0', markup_percent: 'NUMERIC(10,2) NOT NULL DEFAULT 0', profit: 'NUMERIC(14,2) NOT NULL DEFAULT 0', price_total: 'NUMERIC(14,2) NOT NULL DEFAULT 0', real_margin_percent: 'NUMERIC(10,2) NOT NULL DEFAULT 0', status: "TEXT NOT NULL DEFAULT 'ORCAMENTO'", notes: 'TEXT', price_mode: "TEXT NOT NULL DEFAULT 'markup'", created_at: "TIMESTAMPTZ NOT NULL DEFAULT NOW()", updated_at: "TIMESTAMPTZ NOT NULL DEFAULT NOW()", deleted_at: 'TIMESTAMPTZ' }
  };
  for (const [table, defs] of Object.entries(columns)) {
    for (const [column, definition] of Object.entries(defs)) {
